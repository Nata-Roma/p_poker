export const RssIcon = () => {
  return (
    ...
    >
      <style>
        {
          '.prefix__st0{fill:#fff}.prefix__st5,.prefix__st7{fill:#fff;stroke:#000;stroke-width:4;stroke-miterlimit:10}.prefix__st7{fill:none}'
        }
      </style>
      ...
      <g clipPath="url(#prefix__SVGID_2_)">
        ...
        <g id="prefix__Layer_2_1_">
          ...
          <g id="prefix__Layer_1-2" clipPath="url(#prefix__SVGID_4_)">
            <ellipse
              transform="rotate(-37.001 420.46 67.88)"
              className="prefix__st0"
              cx={420.5}
